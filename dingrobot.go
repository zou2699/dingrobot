...
// Roboter is the interface implemented by Robot struct that can send multiple types of messages.
...
// NewRobot returns a roboter than can send messages.
...
// SendActionCard send a ActionCard type message.
